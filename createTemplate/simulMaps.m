...
setpref('mrCurrent','AnatomyFolder','/Volumes/Amrutam/Marlene/JUSTIN/skeriDATA/anatomy')
setpref('freesurfer','SUBJECTS_DIR','/Volumes/Amrutam/Marlene/JUSTIN/skeriDATA/anatomy/FREESURFER_SUBS/')
...
projectDir = '/Volumes/Amrutam/Marlene/JUSTIN/skeriDATA/OriginalSkeriFolders/';
...
for src = 1:size(avROI.activity,2)
    ...
    plotContourOnScalp(avROI.activity(:,src),'skeri0044','/Volumes/Amrutam/Marlene/JUSTIN/PlosOne/github-archive/datafiles/eegdata/')
    view(20,35)
    camproj('perspective')
    axis off
