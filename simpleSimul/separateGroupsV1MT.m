...
% source is ERP from bilateral V1 MT
...
save('simulOutput/separateGroupsV1MT.mat','aucAve','energyAve','mseAveNorm')
...
saveas(gcf,['figures' filesep 'separateGroupsV1MT'],'png')
saveas(gcf,['figures' filesep 'separateGroupsV1MT'],'fig')
print(gcf,['figures' filesep 'separateGroupsV1MT'],'-depsc')
