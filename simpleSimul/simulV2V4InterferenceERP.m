...
%     end % sbj
    ...
    save(['simulOutput/interference/simulVV2V4interferenceERP' num2str(repBoot) '.mat'],'simulERP')
...
mseAveNorm = aucAve;
for repBoot=1:totBoot
    load(['simulOutput/interference/simulVV2V4interferenceERP' num2str(repBoot) '.mat'])
    for model=1:nbModel
        for level=1:length(SNRlevel)
...
saveas(gcf,['figures' filesep 'simulV2V4interferenceERP'],'png')
