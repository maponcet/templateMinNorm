function [reg_min,G,reg_param, minG] = gcv(U,s,b,method, npoints) 
...
%npoints = 50;                      % Number of points on the curve. 
smin_ratio = 0.001;%16*eps;                % Smallest regularization parameter. 
%smin_ratio = eps;
% Initialization. 
