...
for repBoot=1:totBoot
    ...
    srcERPv(ac_sourcesV(1),:) = srcERP(ac_sources(1),:);
    srcERPd(ac_sourcesD(1),:) = srcERP(ac_sources(1),:);
...
%             betaROIinLC = regionWhole;
            ...
            [betaAverageV, lambdaV] = minNormFast_lcurve(avMap, squeeze(mean(Y_avgV,1)));
            [betaAverageD, lambdaD] = minNormFast_lcurve(avMap, squeeze(mean(Y_avgD,1)));
...
save('simulOutput/simulV1splitCompUni.mat','simulERP')


%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%
load('/Users/marleneponcet/Documents/Git/templateMinNorm/simpleSimul/simulOutput/simulV1splitCompUni.mat')
totBoot = 30;SNRlevel = [0.1 1 10 200 10000];winERP = 46:90;
...
saveas(gcf,['figures' filesep 'splitV1CompUni'],'png')
saveas(gcf,['figures' filesep 'splitV1CompUni'],'fig')
print(gcf,['figures' filesep 'splitV1CompUni'],'-depsc')
